// jQuery function to format the date and time with moment.js
...
var time18 = 18;
  ...
  window.requestIdleCallback = window.requestIdleCallback || function(saveHandler) {
    let correctTime = Date.now();
   
    return setTimeout(function() {
      saveHandler({
        didTimeout: false,
        timeRemaining: function() {
          return Math.max(0, 50.0 - (Date.now() - correctTime));
        }
      });
    }, 1);
  }